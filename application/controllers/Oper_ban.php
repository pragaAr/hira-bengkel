...
class Oper_ban extends CI_Controller
{
  ...
  {
    $data = [
      'title' => 'Data Detail Pemakaian Ban'
    ];
  ...
  public function detailData($id)
  {
    $data = [
      'title' => 'Detail Operan',
      'oper'  => $this->OperBan_model->getOperId($id)
    ];
  ...
  public function pengembalian()
  {
    ...
    if ($cekkdpakai === 1) {
      ...
      $query = $this->Oper->updateOper($datakembalipakai, $datakembalidetail, $dataoper, $dataidoper, $datakdpinjam, $datakddetail, $datahistori, $dataStok, $noseri);
    } elseif ($cekkdpakai === 0) {
      ...
      $query = $this->Oper->updateOperan($datakembalioper, $dataidkembalioper, $dthistori, $dataupdateoper, $kodeoper, $dtstok, $dtnoseri);
    }
  ...
  public function getDetailOperAgain()
  {
    ...
    $query = $this->Oper->getDetailOperKd($kd);
  ...
  {
    $data = [
      'pakai'   => $this->PakaiBan_model->getData(),
      'pinjam'  => $this->OperBan_model->getOperId($id)
    ];
