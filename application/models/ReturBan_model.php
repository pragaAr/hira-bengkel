...
class ReturBan_model extends CI_Model
{
  ...
  public function getData()
  {
    $this->datatables->select('
                              a.id_retur_ban, a.kd_retur_ban, 
                              a.kd_beli_ban, a.jml_ban_retur, a.ket_ban_retur, a.tgl_ban_retur, 
  ...
  public function getFilter($awal, $akhir)
  {
    $this->db->select('*')
      ...
      ->join('stok_part', 'stok_part.id_part = retur_part.part_id')
      ->join('merk', 'merk.id_merk = retur_part.merk_id', 'left')
