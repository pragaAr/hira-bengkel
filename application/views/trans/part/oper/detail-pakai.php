      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body" style="font-size:13px">
          <div class="table-responsive">
            <table class="table table-bordered table-hover" id="allPakaiTables" width="100%">
...
<!-- Modal Oper -->
<div class="modal fade p-0" id="operModal" data-backdrop="static">
        ...
        <form action="<?= base_url('oper/operPart') ?>" method="post">
          <div class="form-row">
            ...
            <div class="form-group col-lg-3 col-md-3">
              ...
              <input type="text" class="form-control text-uppercase" id="merk" name="merk" readonly>
