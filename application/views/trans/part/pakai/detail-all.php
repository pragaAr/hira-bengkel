  ...
  <div class="modal-dialog">
    <div class="modal-content p-3">
      <div class="modal-header">
        <h4 class="modal-title" id="retur">Export Detail Pemakaian</h4>
      ...
      <div class="modal-body">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            <label for="truck">Pilih Truck</label>
          ...
          <div class="form-group col-md">
            <button type="submit" class="btn btn-block btn-primary mt-3">PDF</button>
          </div>
        </div>
        </form>
      </div>
