    ...
    <div class="col-md-12">
      <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex align-items-center justify-content-between flex-wrap">
          ...
          <div class="btn-group">
            <a href="<?= base_url('oper_ban') ?>" class="btn btn-dark mb-2">
...
<!-- Modal Oper -->
<div class="modal fade p-0" id="operBanModal" data-backdrop="static">
  <div class="modal-dialog modal-lg">
    <div class="modal-content p-2">
      <div class="modal-header">
        <h5 class="modal-title text-dark font-weight-bold">Form Oper Ban</h5>
        ...
        <form action="<?= base_url('oper_ban/oper') ?>" method="post">
          <div class="form-row">
            <div class="form-group col-lg-4 col-md-4">
              ...
              <input type="hidden" class="form-control text-uppercase" id="kdpakai" name="kdpakai" readonly>
              ...
              <input type="text" class="form-control" id="noseri" name="noseri" readonly>
