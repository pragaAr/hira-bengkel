    ...
    <div class="col-md-12">
      <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex align-items-center justify-content-between flex-wrap">
          ...
          <div class="btn-group">
            <a href="<?= base_url('beli_ban/detailAll') ?>" class="btn btn-success mb-2">
              <i class="far fa-file-alt fa-sm"></i>
              Detail All
            </a>
            <a href="<?= base_url('beli_ban/add') ?>" class="btn btn-dark mb-2">
        ...
        <div class="card-body" style="font-size:13px">
          <div class="table-responsive">
            <table class="table table-bordered table-hover" id="belibanTables" width="100%">
