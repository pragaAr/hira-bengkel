      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered table-hover" id="allPercabTables" width="100%" cellspacing="0">
              <thead class="text-center">
                <tr>
                  <th scope="col" class="align-middle">No</th>
                  <th scope="col" class="align-middle">No Surat</th>
                  <th scope="col" class="align-middle">Cabang</th>
                  <th scope="col" class="align-middle">Bengkel</th>
                  <th scope="col" class="align-middle">Tgl Nota</th>
                  <th scope="col" class="align-middle">Sparepart</th>
                  <th scope="col" class="align-middle">Plat No</th>
                  <th scope="col" class="align-middle">Sopir</th>
                  <th scope="col" class="align-middle">Ongkos</th>
