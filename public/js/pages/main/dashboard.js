...
async function fetchData() {
	...
	try {
		const [
			...
			fetch(
				`http://localhost/he-bengkel/home/getBelanjaPart?month=${inputValue}`
			),
			fetch(
				`http://localhost/he-bengkel/home/getPartTunai?month=${inputValue}`
			),
			fetch(
				`http://localhost/he-bengkel/home/getPartTempo?month=${inputValue}`
			),
			fetch(
				`http://localhost/he-bengkel/home/getBelanjaBan?month=${inputValue}`
			),
			fetch(`http://localhost/he-bengkel/home/getBanTunai?month=${inputValue}`),
			fetch(`http://localhost/he-bengkel/home/getBanTempo?month=${inputValue}`),
			fetch(`http://localhost/he-bengkel/home/getPercab?month=${inputValue}`),
		]);
		...
		const sum =
			parseFloat(sumPartData.total || 0) +
			parseFloat(sumBanData.total || 0) +
			parseFloat(sumPercabData.total || 0);

		allTotalPrice.textContent = "Rp. " + format(sum);
	} catch (error) {
...
async function fetchUpdateData(selectedMonth) {
	try {
		const [
			...
			fetch(
				`http://localhost/he-bengkel/home/getBelanjaPart?month=${selectedMonth}`
			),
			fetch(
				`http://localhost/he-bengkel/home/getPartTunai?month=${selectedMonth}`
			),
			fetch(
				`http://localhost/he-bengkel/home/getPartTempo?month=${selectedMonth}`
			),
			fetch(
				`http://localhost/he-bengkel/home/getBelanjaBan?month=${selectedMonth}`
			),
			fetch(
				`http://localhost/he-bengkel/home/getBanTunai?month=${selectedMonth}`
			),
			fetch(
				`http://localhost/he-bengkel/home/getBanTempo?month=${selectedMonth}`
			),
			fetch(
				`http://localhost/he-bengkel/home/getPercab?month=${selectedMonth}`
			),
		]);
		...
		const sum =
			parseFloat(updatePartData.total || 0) +
			parseFloat(updateBanData.total || 0) +
			parseFloat(updatePercabData.total || 0);
...
async function getDataYearly() {
	...
	try {
		const [partYearly, banYearly] = await Promise.all([
			fetch(
				`http://localhost/he-bengkel/home/getBelanjaPartTahunan?year=${inputYearValue}`
			),
			fetch(
				`http://localhost/he-bengkel/home/getBelanjaBanTahunan?year=${inputYearValue}`
			),
		]);
...
async function fetchUpdateDataYearly(selectedYear) {
	try {
		const [partYearlyUpdate, banYearlyUpdate] = await Promise.all([
			fetch(
				`http://localhost/he-bengkel/home/getBelanjaPartTahunan?year=${selectedYear}`
			),
			fetch(
				`http://localhost/he-bengkel/home/getBelanjaBanTahunan?year=${selectedYear}`
			),
		]);
