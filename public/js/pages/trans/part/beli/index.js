...
$('#belipartTables').DataTable({
  ...
  columns: [
    ...
    },
    {
      ...
      render: function (data, type, row) {
        if (data == 1) {
          return '<a href="http://localhost/he-bengkel/retur" class="btn btn-danger btn-sm rounded-circle" data-toggle="tooltip" title="Ada Retur"><i class="fas fa-exclamation-circle fa-sm"></i></a>';
        } else {
